 ...
 */
static void __list_add(struct list_node *new,
 ...
 */
void list_del(struct list_node *entry)
{
 ...
 */
void list_move(struct list_node *list, struct list_node *head)
{
 ...
 */
void list_move_tail(struct list_node *list,
...
static void __list_splice(struct list_node *list,
				 struct list_node *head)
{
 ...
 */
void list_splice(struct list_node *list, struct list_node *head)
{
	if (!list_empty(list))
 ...
 */
void list_splice_init(struct list_node *list,
				    struct list_node *head)
{
	if (!list_empty(list)) {
		__list_splice(list, head);
